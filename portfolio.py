...
def links_sect():
    ...
    st.sidebar.text("Connect with me on Linkedln")
...
def experience_sect(experience_data):
    ...
    st.write("---")
experience_sect(info.experience_data)

def project_sect(projects_data):
    st.header("Projects")
    for project_name, project_descript in projects_data.items():
        expander=st.expander(f"{project_name}")
        expander.write(project_descript)
    st.write("---")
